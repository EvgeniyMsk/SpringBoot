...
<@common.page>
    ...
    <#if regMessage??>
        <#if regMessage == '1'>
            <@spring.messageText "registerSuccess" "Registration successfully completed!"></@spring.messageText>
        </#if>
        <#if regMessage == '0'>
            <@spring.messageText "registerFail" "Registration error!"></@spring.messageText>
        </#if>
    </#if>
    <div class="tester">
        <fieldset>
