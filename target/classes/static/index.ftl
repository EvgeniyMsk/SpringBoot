...
<@c.page>
    <main>
            <div>
                    ...
                    <h2 class="header"><@spring.messageText "authors" "Authors: "></@spring.messageText> <a class="header" href="https://profile.intra.42.fr/users/qsymond">Qsymond</a> <@spring.messageText "and" "and"></@spring.messageText> <a class="header" href="https://profile.intra.42.fr/users/pcharlot">Pcharlot</a></h2>
            </div>
            <div class="tester">
