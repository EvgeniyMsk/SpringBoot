...
<@common.page>
    ...
    <div class="tester">
            ...
            <table border="3">
                ...
                <#list user.authHistory as iterAuth>
                    <tr>
                        ...
                        <td>
                            <#if iterAuth.type=="0">
                                <@spring.messageText "authType0" "Registration"></@spring.messageText>
                            </#if>
                            <#if iterAuth.type=="1">
                                <@spring.messageText "authType1" "Authorization"></@spring.messageText>
                            </#if>
                        </td>
                        <td>
                            ${iterAuth.address}
        ...
        <h1 class="main">
            <@spring.messageText "AvatarHistory" "Avatar history"></@spring.messageText>
        </h1>
        <div>
            <table border="3">
                <tr>
                ...
                <#list listFiles as filesIter>
                    <tr>
                        <td>
                            <a href="/profile/photo/${filesIter}/show" target="_blank">${filesIter}</a>
                        </td>
                    </tr>
                </#list>
            </table>
